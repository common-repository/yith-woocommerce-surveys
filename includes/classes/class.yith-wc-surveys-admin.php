...
if( !class_exists( 'YITH_WC_Surveys_Admin' ) ){
    ...
    class YITH_WC_Surveys_Admin{
        ...
        public function admin_add_scripts(){
            ...
            wp_enqueue_script( 'yit_survey_script', YITH_WC_SURVEYS_ASSETS_URL.'js/yith_surveys_admin'.$premium.$suffix.'.js', array( 'jquery'), YITH_WC_SURVEYS_VERSION, true );
        ...
        public function update_survey_post_title(){
            ...
            if( !ywcsur_is_premium_active() ){
                ...
                if( 'no' == $updated ){
                    ...
                    $all_children = YITH_Surveys_Type()->get_survey_children( array( 'post_type' => $free_survey_id ) );
